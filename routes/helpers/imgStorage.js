...
var ImgStorage = function (options) {

    // this serves as a constructor
    function ImgStorage(opts) {
    ...
    ImgStorage.prototype._generateRandomFilename = function () {
    ...
    ImgStorage.prototype._createOutputStream = function (filepath, cb) {
    ...
    ImgStorage.prototype._processImage = function (image, cb) {
    ...
    ImgStorage.prototype._handleFile = function (req, file, cb) {
    ...
    ImgStorage.prototype._removeFile = function (req, file, cb) {
